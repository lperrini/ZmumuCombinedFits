...
filesin=["../../../auxiliaries/shapes/TALLINN/ztt_tt_EB.input-sm-13TeV.root"]#,"../../../auxiliaries/shapes/TALLINN/ztt_mm_wTauSpinner.input-sm-13TeV.root"]
...
for f in range (0,nfiles):
   file=ROOT.TFile("../outputs_tt_EB/"+files[f],"r")
   for i in range (0,ncat):
      ...
      if(file.Get(categories[i]).GetListOfKeys().Contains("ZLLsig")):
         ...
         ZLL=h.Clone()
      if(file.Get(categories[i]).GetListOfKeys().Contains("ZTT")):
